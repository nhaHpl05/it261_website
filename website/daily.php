...
include('includes/header.php'); // include from header.php 

?>

<div id="wrapper">
<main>
  <h1 class="align__text">
<?php
    if ($todayDate <= 11) {
...
?> 
    ...
    <img class="image-tree" src="images/<?php echo $pic; ?>" alt="<?php echo $alt; ?>" >  
    <p class="content-text"><?php echo $content; ?></p>
</main> 
      
    <aside>
       <h3>Check out our daily<br> trees of the week</h3> <br>
